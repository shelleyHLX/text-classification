...
class Settings(object):
    def __init__(self):
        self.model_name = 'Attention_TextCNN_add'
        self.fact_len = 200
...
class Atten_TextCNN(object):
    ...
    def task_specific_attention(self, inputs, output_size, initializer=layers.xavier_initializer(),
        ...
        with tf.variable_scope(scope or 'attention') as scope:
            ...
            return weighted_projection+inputs
