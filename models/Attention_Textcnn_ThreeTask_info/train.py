...
def valid_epoch(data_path, sess, model, logger, global_step):
    ...
    for i in range(n_va_batches):
        ...
        feed_dict = {model.X_inputs: X_batch, model.acc_y: acc_batch, model.article_y: law_batch, model.death_y:death_batch,
                     model.imp_y: imp_batch, model.lif_y: lif_batch, model.batch_size: _batch_size,
