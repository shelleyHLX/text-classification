...
embedding_path = '../../data/word2vec_glove_200.npy'
data_train_path = '../../data/s200_word2vec100glove100_bs128/train/'
data_valid_path = '../../data/s200_word2vec100glove100_bs128/valid/'
...
def train_epoch(data_path, sess, model, train_fetches, valid_fetches, train_writer, test_writer, logger):
    global last_score12
    global lr
    time0 = time.time()
