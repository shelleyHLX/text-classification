...
class Settings(object):
    def __init__(self):
        self.model_name = 'FC_Attention_TextCNN'
        self.fact_len = 200
...
class Atten_TextCNN(object):
    ...
    def _inference(self, X_inputs):
        ...
        # MLP
        inputs=tf.layers.dense(inputs,self.hidden_size,activation=tf.nn.relu,use_bias=True) #[batch_size,sequence_length,hidden_size]
        inputs = self.task_specific_attention(inputs, self.embedding_size)
