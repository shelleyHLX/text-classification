...
# w
batch_train_path = '../data/wd_pdQS200_bs32/train/'
batch_valid_path = '../data/wd_pdQS200_bs32/valid/'
batch_test_path = '../data/wd_pdQS200_bs32/test/'
...
if __name__ == '__main__':
    valid_test_get_batch(file_word2id_va, y_file_valid, batch_valid_path)
