...
from models.biblosa.nn_utils.baselines.SRU import NormalSRUCell
...
def contextual_bi_rnn(tensor_rep, mask_rep, hn, cell_type, only_final=False,
    ...
    with tf.variable_scope(scope or 'contextual_bi_rnn'): # correct
        ...
        (outputs_fw, output_bw), _=bidirectional_dynamic_rnn(cell_dp_fw, cell_dp_bw, tensor_rep, tensor_len, dtype=tf.float32)
